...
const Data = () =>{
    return (
        <div className='home__data'> 
                <h1 className='home__title'>Pathum Ranahansa
                ...
                <p className='home__description'>I am a software engineer based in Colombo, Sri Lanka and I'm very passionate about programming and dedicated to my work. </p>
